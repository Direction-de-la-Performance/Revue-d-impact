...
import { ANNEE_BILAN } from "./config.js";
...
export const INDICATEURS = [
  { id:"DYN",        label:"DYN",        nom:"Dynamisation de l'accompagnement",                 domaine:"acco", type:"taux",   pct:true,  fourchette:true,
    aide:"Part des demandeurs d'emploi accompagnés ayant eu au moins un acte d'accompagnement récent (entretien, atelier, mise en relation) sur la période. Mesure l'intensité réelle du suivi, pas seulement son existence sur le papier." },
  { id:"SATIS_ACCO", label:"Satis Acco", nom:"Satisfaction relative à l'accompagnement",         domaine:"acco", type:"taux",   pct:true,  fourchette:true,
    aide:"Part des demandeurs d'emploi se déclarant satisfaits de leur accompagnement, mesurée par enquête déclarative (baromètre usagers)." },
  { id:"F_TAE",      label:"F-TAE",      nom:"Accès à l'emploi 6 mois après formation « emploi direct »", domaine:"acco", type:"taux", pct:true, fourchette:true,
    aide:"Part des bénéficiaires d'une formation « emploi direct » ayant retrouvé un emploi dans les 6 mois suivant la fin de la formation. Mesure l'efficacité des formations orientées insertion rapide." },
  { id:"DELD",       label:"DELD",       nom:"Demandeurs d'emploi de longue durée",              domaine:"acco", type:"volume", pct:false, fourchette:true, sensInverse:true,
    aide:"Nombre de demandeurs d'emploi inscrits depuis plus d'un an (catégories A, B, C). Une baisse traduit une sortie plus rapide du chômage de longue durée." },
  { id:"F_PRIO",     label:"F-PRIO",     nom:"Part des publics prioritaires dans les entrants en formation", domaine:"acco", type:"taux", pct:true, fourchette:true,
    aide:"Part des publics prioritaires (jeunes, seniors, bénéficiaires du RSA, QPV...) parmi les nouveaux entrants en formation. Vérifie que l'effort de formation cible bien les publics qui en ont le plus besoin." },
  { id:"TAE",        label:"TAE",        nom:"Taux d'accès à l'emploi",                          domaine:"acco", type:"taux",   pct:true,  fourchette:true,
    aide:"Part des demandeurs d'emploi accompagnés ayant retrouvé un emploi (CDI, CDD, intérim) sur la période, tous types de sortie confondus. Indicateur central de l'efficacité de l'accompagnement." },
  { id:"TPED",       label:"TPED",      nom:"Taux de présence en emploi durable",               domaine:"acco", type:"taux",   pct:true,  fourchette:true,
    aide:"Part des sorties vers l'emploi qui se maintiennent au moins 6 mois en emploi durable (CDI ou CDD/intérim de 6 mois et plus). Distingue le retour à l'emploi réel de la sortie statistique éphémère." },
  { id:"INTENSIF",   label:"Acco intensif", nom:"Entrées en accompagnement intensif",           domaine:"acco", type:"volume", pct:false, fourchette:true,
    aide:"Nombre de demandeurs d'emploi entrés en accompagnement intensif (portefeuille réduit, suivi rapproché) sur la période. Levier prioritaire de la campagne nationale." },
  { id:"IMMERSIONS", label:"Immersions", nom:"Nombre d'immersions",                              domaine:"acco", type:"volume", pct:false, fourchette:true,
    aide:"Nombre de périodes de mise en situation en milieu professionnel (PMSMP) réalisées sur la période. Sert à tester un métier ou confirmer un projet avant la formation ou l'embauche." },
  { id:"ENT_PLUS",   label:"ENT+",       nom:"Part des établissements ayant recours à France Travail", domaine:"pro", type:"taux", pct:true, fourchette:true,
    aide:"Part des établissements du territoire ayant sollicité France Travail au moins une fois sur la période (offre, prestation, conseil recrutement). Mesure la pénétration du service auprès des employeurs." },
  { id:"TPO",        label:"TPO",        nom:"Taux de pourvoi des offres",                       domaine:"pro",  type:"taux",   pct:true,  fourchette:true,
    aide:"Part des offres d'emploi déposées qui ont été effectivement pourvues (avec ou sans l'intermédiation de France Travail) sur la période." },
  { id:"SATIS_ENT",  label:"Satis Ent",  nom:"Satisfaction des entreprises",                     domaine:"pro",  type:"taux",   pct:true,  fourchette:true,
    aide:"Part des entreprises se déclarant satisfaites du service rendu par France Travail, mesurée par enquête déclarative." },
  { id:"PROSPEC",    label:"Prospections", nom:"Prospections / fidélisation",                    domaine:"pro",  type:"volume", pct:false, fourchette:true,
    aide:"Nombre de contacts actifs (visites, appels, actions commerciales) réalisés auprès d'entreprises, nouvelles ou déjà clientes, sur la période. Ambition nationale : 500 000 en 2026." },
  { id:"TP",         label:"TP",         nom:"Taux de trop-perçus",                              domaine:"ind",  type:"taux",   pct:true,  fourchette:true, sensInverse:true,
    aide:"Part des allocations versées ayant fait l'objet d'un trop-perçu (erreur ou changement de situation non déclaré à temps). Une baisse traduit une meilleure fiabilité du versement initial." },
  { id:"SATIS_IND",  label:"Satis Ind",  nom:"Satisfaction relative à l'indemnisation",          domaine:"ind",  type:"taux",   pct:true,  fourchette:true,
    aide:"Part des allocataires se déclarant satisfaits du traitement de leur dossier d'indemnisation, mesurée par enquête déclarative." },
  { id:"CDALB",      label:"CDALb",      nom:"Conformité du traitement de la demande d'allocation", domaine:"ind", type:"taux", pct:true,  fourchette:false,
    aide:"Part des dossiers d'allocation traités conformément aux règles (pièces, calcul, délais). Objectif imposé nationalement, sans marge de négociation locale." },
  { id:"DPO",        label:"DPO",        nom:"Délai de pourvoi des offres (jours)",              domaine:"pro",  type:"taux",   pct:false, fourchette:false, sensInverse:true,
    aide:"Délai moyen, en jours, entre le dépôt d'une offre et son pourvoi effectif. Objectif imposé nationalement." },
  { id:"DEMAR",      label:"DEMAR",      nom:"DE ayant signé un contrat d'engagement",           domaine:"acco", type:"taux",   pct:true,  fourchette:false,
    aide:"Part des demandeurs d'emploi ayant signé un contrat d'engagement formalisant leur parcours d'accompagnement. Objectif imposé nationalement." },
  { id:"IQVCT",      label:"IQVCT",      nom:"Indice de qualité de vie et des conditions de travail", domaine:"perf", type:"taux", pct:true, fourchette:true, objectifSimple:true,
    aide:"Indice composite issu de l'enquête interne QVCT (charge de travail, soutien managérial, sens au travail...). Mesure le climat social perçu par les agents." },
  { id:"ENGAGEMENT", label:"Engagement", nom:"Indice d'engagement des collaborateurs",           domaine:"perf", type:"taux",   pct:true,  fourchette:true, objectifSimple:true,
    aide:"Indice mesurant l'implication et l'adhésion des agents aux objectifs de leur structure, issu de l'enquête interne annuelle." },
  { id:"ABSENTEISME",label:"Absentéisme",nom:"Taux d'absentéisme",                                domaine:"perf", type:"taux",   pct:true,  fourchette:true, objectifSimple:true, sensInverse:true,
    aide:"Part des jours d'absence (hors congés) rapportée au nombre de jours travaillés théoriques. Une baisse traduit une meilleure qualité de vie au travail." },
];
...
export const TRAME = {
  acco: {
    bilan: [
      { id:"reussites", label:"Réussites", q:`Quelles ont été vos percées, vos réussites en ${ANNEE_BILAN} ? Quels éléments de votre stratégie territoriale peuvent les expliquer ?` },
  ...
  pro: {
    bilan: [
      { id:"reussites", label:"Réussites", q:`Quelles ont été vos percées, vos réussites en ${ANNEE_BILAN} sur la relation entreprise ?` },
  ...
  ind: {
    bilan: [
      { id:"reussites", label:"Réussites", q:`Quelles réussites ${ANNEE_BILAN} en matière d'indemnisation ?` },
  ...
  perf: {
    bilan: [
      { id:"reussites", label:"Réussites", q:`Quelles réussites ${ANNEE_BILAN} en matière de performance sociale (QVCT, engagement, absentéisme) ?` },
  ...
  eff: {
    bilan: [
      { id:"reussites", label:"Réussites", q:`Quels gains d'efficience et coopérations réussies en ${ANNEE_BILAN} ?` },
